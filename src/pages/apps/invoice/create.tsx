                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm={6} md={3}>
                                ...
                                {touched.date && errors.date && (
                                    <FormHelperText error={true}>{errors.date as string}</FormHelperText>
                                )}
                            </Grid>
                            <Grid item xs={12} sm={6} md={3}>
                                <Stack spacing={1}>
                                ...
                                {touched.due_date && errors.due_date && (
                                    <FormHelperText error={true}>{errors.due_date as string}</FormHelperText>
                                )}
                            </Grid>
                                            ...
                                            <Stack spacing={2}>
                                                ...
                                                <Stack sx={{ width: '100%' }}>
                                                    <Typography variant="subtitle1">
                                                        {values?.cashierInfo?.name}
                                                    </Typography>
                                                    <Typography color="secondary">
                                                        {values?.cashierInfo?.address}
                                                    </Typography>
                                                    <Typography color="secondary">
                                                        {values?.cashierInfo?.phone}
                                                    </Typography>
                                                    <Typography color="secondary">
                                                        {values?.cashierInfo?.email}
                                                    </Typography>
                                                </Stack>
                                            </Stack>
                                        </Grid>
                                                    ...
                                                    !Array.isArray(errors?.invoice_detail) && (
                                                        <Stack direction="row" justifyContent="center" sx={{ p: 1.5 }}>
                                                            <FormHelperText error={true}>
                                                                {errors.invoice_detail as string}
                                                            </FormHelperText>
                                                        </Stack>
                                                    )}
                                ...
                                <Stack spacing={1}>
                                    ...
                                    <FormControl sx={{ width: { xs: '100%', sm: 250 } }}>
                                        <Autocomplete
                                            ...
                                            value={invoiceMaster.countries.find(
                                                (option: CountryType) => option.code === invoiceMaster.country?.code
                                            )}
                                            ...
                                            renderInput={(params) => {
                                                const selected = invoiceMaster.countries.find(
                                                    (option: CountryType) => option.code === invoiceMaster.country?.code
                                                );
                                                return (
                                                    <TextField
