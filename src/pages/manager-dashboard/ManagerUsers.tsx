                    ...
                    return (
                        <>
                            <Stack direction="row" alignItems="center" spacing={2}>
                                <Tooltip title="Login as Consultant" arrow TransitionComponent={Zoom}>
                                    <IconButton color="primary" size="medium">
                                        <Lock1 scale={24} />
                                    </IconButton>
                                </Tooltip>
                                <Tooltip title="Edit User" arrow TransitionComponent={Zoom}>
                                    <IconButton
                                        component={Link}
                                        to={`/Admin/UsersEdit/${props.row.original.company}`}
                                        color="primary"
                                        size="medium"
                                    >
                                        <Edit scale={24} />
                                ...
                                <IconButton color="error" size="medium" onClick={handleReactive}>
                                    <Trash scale={24} />
                                </IconButton>
                            </Stack>
                        </>
    ...
    return (
        <>
            <MainCard content={false}>
                ...
                <Divider />
                <Stack direction={{ xs: 'column', sm: 'row' }} justifyContent="space-between" spacing={2} p={2}>
                    <Autocomplete
                        freeSolo
                        options={top100Films}
                        renderInput={(params) => (
